...
def main():
    ...
    d["spark"] = sparks
    d["spark_not"] = ("Son 2 yıl, haftalık kapanış, ilk gözlem = 100. "
                      "Seriler farklı uzunlukta olabilir (kuruluş tarihi farklı).")
    ...
    print("örnek ARKG:", sparks.get("ARKG", [])[:6], "...")
